...
public class ResponseQTest {
	...
	public static final QuestionType QUESTION_TYPE = QuestionType.RESPONSE;
	...
	public void initializeTests() throws SQLException{
		System.out.println("Start Question Response Test");
	...
	public void destroyTests() throws SQLException{
		...
		System.out.println("End Question Response Test");
	}	
	...
	public void testResponseQ() throws SQLException{
		...
		for(Quiz quiz:quizzes){
			...
			rq.addSolutions(SOLUTIONS);
			HashSet<String> sols = rq.getSolutions();
			assert(rq.getSolutions().equals(SOLUTIONS));
			
			rq.addSolution("Sol5");
			assert(rq.isSolution("Sol5"));
			
			rq.removeSolution("Sol5");
			assert(rq.getSolutions().equals(SOLUTIONS));
		}
	}
	/*-------------------------- END TEST FUNCTIONS ------------------------------------*/
