...
public class QuizTest {
	...
	public void testQuiz() throws SQLException{
		...
		for(Quiz quiz:quizzes){
			...
			assertEquals(quiz.getNumTakersWhoDislikeQuiz(),10);
			...
			u = um.getExistingUser(TConst.TEST_USER_NAME.get(0));
			assert(quiz.getTakersWhoDislikeQuiz().contains(u));
			
			for(User user:quiz.getTakersWhoDislikeQuiz()){
