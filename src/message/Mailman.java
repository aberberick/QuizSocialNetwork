...
public class Mailman {
	...
	private int currentCount() throws SQLException {
		Statement state = (Statement) con.createStatement();
		rs = state.executeQuery("SELECT * from messages");
		rs.last();
		return rs.getRow();
	}
	...
	private void createMessageTableInDB() throws SQLException {
		Statement state=(Statement) con.createStatement();
		state.executeUpdate("CREATE TABLE IF NOT EXISTS messages (" 
				+ "sender CHAR(64)," 
				+ "receiver CHAR(64),"
				+ "date CHAR(64),"
				+ "type CHAR(64),"
