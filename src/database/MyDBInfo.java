...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108andrewb8";
	public static final String MYSQL_PASSWORD = "gahgohyo";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user-master.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_andrewb8 ";
