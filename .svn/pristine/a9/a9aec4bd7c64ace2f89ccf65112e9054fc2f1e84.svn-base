...
public class MultipleChoiceQTest {
	...
	public static final HashSet<String> CHOICES1 = 
		new HashSet(Arrays.asList(new String[] {"Choice1","Choice2","Choice3","Choice4"}));
	public static final HashSet<String> CHOICES2 = 
		new HashSet(Arrays.asList(new String[] {"Choice1","Choice2","Choice3","Choice4","Choice5"}));
	...
	public void testMultipleChoiceQ() throws SQLException{
		...
		for(Quiz quiz:quizzes){
			...
			mcq.addChoices(CHOICES1);
			mcq.setSolution(SOLUTION);
			
			assert(mcq.getChoices().equals(CHOICES1));
			...
			mcq.addChoice("Choice5");
			for (String choice:mcq.getChoices()){
				System.out.println(choice);
			}
			
			assert(mcq.getChoices().equals(CHOICES2));
			mcq.removeChoice("Choice5");
			assert(mcq.getChoices().equals(CHOICES1));
		}
	}
	/*-------------------------- END TEST FUNCTIONS ------------------------------------*/
